...
import { createProject } from "../data/projectData.ts"
...
export default function NewProject() {
  ...
  return (
    <div className="h-auto">
      <Link to="/dashboard">
        <button className="bg-white mt-5 w-32 h-12 hover:border-4 rounded-lg hover:border-black hover:bg-blue hover:text-white">
          Back
        </button>
      </Link>
      <div className="flex flex-col p-5 text-black mb-5 h-auto rounded-lg bg-off-white">
        <input
          ...
          className="text-2xl p-1 rounded-lg bg-white border-2 border-blue focus:outline-0 focus:shadow-none"
        ></input>
        <span
          className={
