  ...
  useEffect(() => {
    async function setUserPictures() {
      ...
      for (let user of projectUsers) {
        let selectedPhoto = profilePictures.find(
          (picture) => picture.key == user.pictureID
        )
        if (selectedPhoto) {
  ...
  useEffect(() => {
    if (modalAction !== null) {
      ...
      if (modalAction == "Delete") {
        ...
        type.message =
          "Are you sure you want to delete this project? If you delete it, it will be deleted from your history forever, and all tasks under this project will also be deleted."
        type.action = "DeleteProject"
      } else if (modalAction == "Archive") {
        type.title = "Mark as completed"
        type.message =
          "Are you sure you want to mark this project as completed? All tasks under this project will be marked completed as well."
        type.action = "ArchiveProject"
      } else if (modalAction == "Revert") {
        type.title = "Revert Project"
        type.message =
          "Are you sure you want to change this project from complete to in-progress? All tasks under this project will be marked as in-progress."
